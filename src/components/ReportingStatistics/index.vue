<template>
  <div class="reporting-statistics">
    <el-collapse v-model="activeNames">
      <el-collapse-item name="first">
        ...
        <div class="collapse-content usage">
          <div id="userSessionsChart" style="width: 100%; height: 500px;"></div>
        </div>
      </el-collapse-item>
      <el-collapse-item name="second">
        ...
        <div class="collapse-content score-distribution">
          <div
            id="scoreDistributionChart3"
            style="width: 100%; height: 500px;"
          ></div>
        </div>
      </el-collapse-item>
      <el-collapse-item title="地域分布" name="three">
        <div class="collapse-content geographical-distribution">
          <div
            id="geographicalDistributionChart"
            style="width: 100%; height: 500px;"
          ></div>
        </div>
      </el-collapse-item>
...
export default {
  ...
  methods: {
    draw1() {
      const userSessionsChart = this.$echarts.init(
        document.getElementById("userSessionsChart")
      );
      const option = {
        xAxis: {
          type: "category",
      ...
      userSessionsChart.setOption(option);
      window.addEventListener("resize", function () {
        userSessionsChart.resize();
      });
    },
    draw2() {
      const scoreDistributionChart = this.$echarts.init(
        document.getElementById("scoreDistributionChart3")
      );
      const option = {
        tooltip: {
          trigger: "axis",
    ...
    draw3() {
      const geographicalDistributionChart = this.$echarts.init(
        document.getElementById("geographicalDistributionChart")
      );
      let data = [
    {name: '海门', value: 9},
    {name: '鄂尔多斯', value: 12},
    ...
    {name: '克拉玛依', value: 72}
      ...
      geographicalDistributionChart.setOption(option);
      window.addEventListener("resize", function () {
        geographicalDistributionChart.resize();
      });
    },
  },
};
